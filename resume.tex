...
\geometry{left=1.4cm, top=.2cm, right=1.4cm, bottom=1.8cm, footskip=.3cm}
...
\homepage{http://www.raymatsumoto.com}
\github{rmatsum836}
%\linkedin{junhaodong}
% \gitlab{gitlab-id}
...
%-------------------------------------------------------------------------------
\input{resume/tbrays_summary.tex}
%\input{resume/summary.tex}
\input{resume/education.tex}
\input{resume/skills.tex}
\input{resume/experience.tex}
\input{resume/teaching.tex}
\input{resume/tbrays_projects.tex}
