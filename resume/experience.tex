  ...
  \cventry
    ...
    {August 2016 - May 2021} % Date(s)
    {
        \begin{cvfirstitemstitle}
            \entrysubpostyle{Scientific Research: Simulated electrolytes
      ...
      \end{cvsubitems}
      \begin{cvitemstitle}
         \entrysubpostyle{Software: Developed open-source software for reproducible simulation workflows}
      \end{cvitemstitle}
      \begin{cvsubitems}
