...
\name{Ray}{Matsumoto}
\position{Scientific Researcher{\enskip\cdotp\enskip}Data Analyst}
...
\lettertitle{Job Application for Earth Science Informatics Research Professional}
...
I am an enthusiastic researcher and am writing to express my interest in
    joining the Environmental Sciences Division at Oak Ridge National Laboratory.  
    I am particularly excited about the work of using data to support projects
    in Environmental Data Science.

    I believe my background would make me a great fit with your division.  During my
    ...
    My work in this area resulted in 10 peer-reviewed journal articles and 2
    conference presentations.

    Additionally, I am dedicated to expanding my technical skillset and learning new approaches to
    ...
    and baseball datasets.  My understanding is that the above skills would be
    transferable with the tasks performed in Environmental Data Science.
    ...
    Environmental Data Science efforts as an Informatics Research Professional.
